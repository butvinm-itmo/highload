...
import com.github.butvinmitmo.notificationservice.infrastructure.security.GatewayAuthenticationWebFilter
...
class SecurityConfig(
    ...
    fun securityWebFilterChain(http: ServerHttpSecurity): SecurityWebFilterChain =
        http
            ...
            .authorizeExchange {
                it
                    // WebSocket path - auth handled by gateway headers
                    .pathMatchers("/ws/**")
                    .permitAll()
                    // Health and API docs
