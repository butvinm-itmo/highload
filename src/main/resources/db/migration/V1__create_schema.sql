...
-- Таблица типов арканов
CREATE TABLE arcana_type (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    name VARCHAR(16) NOT NULL,
    CONSTRAINT check_arcana_type CHECK (name IN ('MAJOR', 'MINOR'))
);
...
-- Уникальный индекс для предотвращения дублирования позиций в раскладе
