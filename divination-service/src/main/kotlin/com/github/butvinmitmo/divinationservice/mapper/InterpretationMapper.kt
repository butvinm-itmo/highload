...
class InterpretationMapper(
    ...
    fun toDto(interpretation: Interpretation): Mono<InterpretationDto> =
        Mono
            .fromCallable { userServiceClient.getUserById(systemUserId, systemRole, interpretation.authorId).body!! }
